...
<table class="chart">
  <tr>
    <th>finch</th><td><div class="chart-bar finch" style="width: 14%;">0.12s&nbsp;</div></td>
  </tr>
  <tr>
...
<table class="chart">
  <tr>
    <th>finch</th><td><div class="chart-bar finch" style="width: 22%;">0.13s&nbsp;</div></td>
  </tr>
  <tr>
...
<table class="chart">
  ...
  <tr>
    <th>finch</th><td><div class="chart-bar finch" style="width: 41%;">0.22s&nbsp;</div></td>
  </tr>
  <tr>
...
Finch's inheritance hierarchy is static and fixed at class definition time. This
...
Finch's closest sibling, by far, is Lua. Lua is more dynamic than Finch which
