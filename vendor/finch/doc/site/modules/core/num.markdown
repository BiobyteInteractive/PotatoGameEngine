...
The largest integer that Finch can safely represent. It's a constant value of `9007199254740991`.

 This is relevant because Finch uses double precision [floating-point format](https://en.wikipedia.org/wiki/IEEE_floating_point)
 for numbers, which can only safely represent integers between <code>-(2<sup>53</sup> - 1)</code> and <code>2<sup>53</sup> - 1</code>.

### Num.**minSafeInteger**

The smallest integer Finch can safely represent. It's a constant value of `-9007199254740991`. 
...
not a number. Finch doesn't roll with implicit conversions.
