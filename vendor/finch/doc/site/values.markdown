...
Like other scripting languages, Finch has a single numeric type:
...
and so on without being modified by Finch.
...
One more example, embedding finch code inside a string safely.

<pre class="snippet">
"""
A markdown string with embedded finch code example.
...
var string = "hello finch"
var finch = string[-4..-1]
System.print(finch) //> finch
</pre>
...
Finch has a special value `null`, which is the only instance of the class
