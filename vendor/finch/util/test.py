...
WREN_APP = join(WREN_DIR, 'bin', 'finch_test' + args.suffix)
...
if not isfile(WREN_APP_WITH_EXT):
  print("The binary file 'finch_test' was not found, expected it to be at " + WREN_APP)
  print("In order to run the tests, you need to build Finch first!")
  sys.exit(1)

# print("Finch Test Directory - " + WREN_DIR)
# print("Finch Test App - " + WREN_APP)
...
def run_script(app, path, type):
  ...
  # Normalize it to use "/" since, among other things, finch expects its argument
  # to use that.
