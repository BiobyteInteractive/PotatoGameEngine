...
// Exit codes used by the finch binaries, following the BSD standard
//
...
//vm helpers
  ...
  void reportError(FinchVM* vm, FinchErrorType type, const char* module, int line, const char* message);
