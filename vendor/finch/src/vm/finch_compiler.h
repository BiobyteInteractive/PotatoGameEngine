#ifndef finch_compiler_h
#define finch_compiler_h
...
// This module defines the compiler for Finch. It takes a string of source code
// and lexes, parses, and compiles it. Finch uses a single-pass compiler. It
...
// Compiles [source], a string of Finch source code located in [module], to an
