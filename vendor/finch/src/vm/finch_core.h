...
// language.
//
// With Finch, we try to do as much of it in C as possible. Primitive methods
// are always faster than code written in Finch, and it minimizes startup time
// since we don't have to parse, compile, and execute Finch code.
//
// There is one limitation, though. Methods written in C cannot call Finch ones.
